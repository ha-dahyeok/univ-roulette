...
GATES = [
    {"name": "정문", "lat": 37.447496, "lng": 126.653005},
    {"name": "의과대학 입구", "lat": 37.451471, "lng": 126.654508},
    {"name": "후문", "lat": 37.451012, "lng": 126.656389}
]

CSV_PATH = 'c:/Ha_dahyeok/2026_NEXT_CONTEST/inha_restaurants.csv'
SEARCH_RADIUS = 300
...
def determine_price(name, category):
    ...
    return '1' # 인하대 후문/정문 상권은 저렴한 가성비 맛집 위주라 기본을 1단계로 설정
        ...
        for page in range(1, 46):
            ...
            try:
                ...
                for p in places:
                    ...
                    clean_name = name.replace(" 인하대점", "").replace(" 인하점", "").replace(" 본점", "").replace(" 인하대역점", "")
                    ...
                    row = ["인하대학교 용현캠퍼스", name, short_cat, gate['name'], price, url_link]
                    new_rows.append(row)
                    existing.add(name)
