...
GATES = [
    {"name": "정문", "lat": 37.551575, "lng": 126.937658},
    {"name": "체육관 입구", "lat": 37.549519, "lng": 126.938774},
    {"name": "리치과학관 입구", "lat": 37.549642, "lng": 126.941123},
    {"name": "인문대학 후문", "lat": 37.550248, "lng": 126.943786}
]

CSV_PATH = 'c:/Ha_dahyeok/2026_NEXT_CONTEST/sogang_restaurants.csv'
SEARCH_RADIUS = 300
        ...
        for page in range(1, 46):
            ...
            try:
                ...
                for p in places:
                    ...
                    clean_name = name.replace(" 서강대점", "").replace(" 서강점", "").replace(" 본점", "").replace(" 신촌점", "")
                    ...
                    row = ["서강대학교 서울캠퍼스", name, short_cat, gate['name'], price, url_link]
                    new_rows.append(row)
                    existing.add(name)
