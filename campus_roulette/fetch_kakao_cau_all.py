...
GATES = [
    {"name": "정문", "lat": 37.506904, "lng": 126.958466},
    {"name": "중문(청룡연못)", "lat": 37.505958, "lng": 126.957083},
    {"name": "후문(중앙문화예술관)", "lat": 37.505005, "lng": 126.953871}
]

CSV_PATH = 'c:/Ha_dahyeok/2026_NEXT_CONTEST/cau_restaurants.csv'
SEARCH_RADIUS = 300
        ...
        for page in range(1, 46):
            ...
            try:
                ...
                for p in places:
                    ...
                    clean_name = name.replace(" 중앙대점", "").replace(" 흑석점", "").replace(" 본점", "")
                    ...
                    row = ["중앙대학교 서울캠퍼스", name, short_cat, gate['name'], price, url_link]
                    new_rows.append(row)
                    existing.add(name)
